    ...
    return new Promise ((resolve, reject) => {
        ...
        if (!items || !items.length) {
            ...
            items.forEach(function (item) {
                ...
                newItem.CompanySignedId=item.CompanySignedId;     // Company Signed by ID, string
                newItem.CompanySignedDate=item.CompanySignedDate;       // date
                newItem.CustomerSignedId=item.CustomerSignedId;       // Customer Signed By ID, string
                ...
                newItem.ActivatedById=item.ActivatedById;     // string
